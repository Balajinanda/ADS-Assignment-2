# -*- coding: utf-8 -*-
"""
Created on Wed Apr  5 23:11:24 2023
...
#Load the data from World Bank data
...
df_filtered = df[df['Indicator Name'] == \
...
for country in countries:
    ...
    if not country_data.empty:
        ...
        print(country + ": Mean = " + \
              str(mean) + ", Standard Deviation = " + str(stdev))


#Plotting line graph 1
plt.figure(figsize = (10,6))
plt.plot(df_filtered.transpose(),linestyle='--')
plt.legend(countries,bbox_to_anchor=(1.02, 1),\
...
for country in countries:
    ...
    if not country_data.empty:
        ...
        print(country + ": Median = " +\
              str(median) + ", Standard Deviation = " + str(stdev))
